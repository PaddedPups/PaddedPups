...
class DtextInput < SimpleForm::Inputs::TextInput
  def input(wrapper_options = nil)
    ...
    @builder.template.render("dtext_input", textarea: super(merged_input_options), limit: @options[:limit], allow_color: @options.key?(:allow_color) ? @options[:allow_color] : CurrentUser.user.is_trusted?)
  end
